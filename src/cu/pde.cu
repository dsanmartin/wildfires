...
__global__
void RHS(double t, double *R_old, double *R_new, double *R_turbulence, double *z, Parameters parameters) {
...
void Phi(double t, double *R_old, double *R_new, double *R_turbulence, double *z, Parameters parameters) {
    RHS<<<BLOCKS, THREADS>>>(t, R_old, R_new, R_turbulence, z, parameters);
