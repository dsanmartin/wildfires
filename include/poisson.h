...
// void thomas_algorithm_debug(fftw_complex *a, fftw_complex *b, fftw_complex *c, fftw_complex *d, fftw_complex *x, fftw_complex *l, fftw_complex *u, fftw_complex *y, fftw_complex *U, fftw_complex *L, fftw_complex *Y, fftw_complex *D, int r, int s, int N);
